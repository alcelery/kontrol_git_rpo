...
15. Изменение одной строки локально и изменение ее по другому на GitHub
16. Появление конфликта при pull и решение принять оба изменения 
17.  Полное изменение README
...
Локально была поменяна строка в README, и в GitHub тоже была измененна таже строка. Из-за этого возникает конфликт, где при загрузки изменений из GitHub мы не можем этого сделать, потому что гит не может решиться, какую строку оставить. Для этого нам надо обратиться к ошибке, которую выдает при pull и там выбрать какое изменение осавить или вооьще оставить оба. После добавить изменения в staged и закомитить. 
...
## Вывод
Были повторены темы по гиту и гитхабу, такие как клонирование, создание комитов, разрешение конфликтов, слияние веток, создание .gitignore
